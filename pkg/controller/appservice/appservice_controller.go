...
import (
	...
	appv1alpha1 "github.com/qianbaidu/operator-demo/pkg/apis/app/v1alpha1"
...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if err := controllerutil.SetControllerReference(instance, pod, r.scheme); err != nil {
		loger.Error(err, "Set AppService instance as the owner and controller error ")
		return reconcile.Result{}, err
	} else {
		loger.Info("Set AppService instance as the owner and controller success")
	}
